function UI(title, content){
    ...
    <div id="Popup">
    <div style="display: flex; align-items: center; flex-direction: column; position: fixed; top: 50%; left: 50%; transform: translate(-50%, -50%); background-color:crimson; max-width: 400px; width: 70vw; border-radius: 25px; user-select: none; z-index: 0.4;">
    ...
    <div style="position: fixed; top: 0; left: 0; width: 100vw; height: 100vh; background-color: rgba(0, 0, 0, 0.3); z-index: 0.3;"></div>
    </div>
    `;
}